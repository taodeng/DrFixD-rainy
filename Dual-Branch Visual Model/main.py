...
name = 'traffic_net'
ckpts = '/home/tianh/envv2.7/CDNN-traffic-saliency-master/lstm_concat/ckpts_lstm2danxiang/'  #save model
...
def main():
    ...
    root1='/home/tianh/envv2.7/CDNN-traffic-saliency-master/lstm_concat/'
    root2='/home/tianh/envv2.7/CDNN-traffic-saliency-master/lstm_concat/ten_frames/18frames/'
    
    train_imgs = [json.loads(line) for line in open(root1 + 'train.json')]

    valid_imgs = [json.loads(line) for line in open(root1 + 'valid.json')]

    test_imgs = [json.loads(line) for line in open(root2 + 'test.json')]
...
def predict(valid_loader, model):
    ...
    return outputs, targets , losses.avg
